# cn-platformhoctructuyen-laravel
...
```bash
git clone https://github.com/organization-codeflow/cn-platformhoctructuyen-laravel.git
cd cn-platformhoctructuyen-laravel
```
...
- Truy cập: https://sonarcloud.io/project/overview?id=cn-platformhoctructuyen-laravel
- Xem các metrics:
